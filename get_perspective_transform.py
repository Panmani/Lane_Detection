...
def find_inverse_perspective():
    ...
    dst_points = np.array([[settings.UNWARPED_SIZE[0] // 3, settings.UNWARPED_SIZE[1] // 5], 
                           [settings.UNWARPED_SIZE[0] * 2 // 3, settings.UNWARPED_SIZE[1] // 5],
                           [settings.UNWARPED_SIZE[0] * 2 // 3, settings.UNWARPED_SIZE[1]],
                           [settings.UNWARPED_SIZE[0] // 3, settings.UNWARPED_SIZE[1]]], dtype=np.float32)
    ...
    test_files = ['test_images/test3d.jpg']
